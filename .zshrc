...
alias libupdate="brew update; brew upgrade; oh-my-zsh_update; npm -g outdated; echo '\nOutdated gems'; gemo; echo '\nOutdated pips'; pipo"
alias ldbs="listdbs"
...
alias oh-my-zsh_update="echo '\nUpdating Oh My ZSH'; cd ~/.oh-my-zsh; gsta; gl; gstp; cd -"
alias pf="peerflixrb"
