...
alias co="codex --model gpt-5.6-sol --config 'model_reasoning_effort=\"xhigh\"'"
...
function libupdate() {
  ...
  curl -Lo nvim "https://github.com/neovim/neovim-releases/releases/download/v0.12.4/nvim-linux-x86_64.appimage"
  ...
  gem install awesome_print mki_cli pry pry-doc ruby-lsp ruby-lsp-rails
