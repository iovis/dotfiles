...
alias gemupdate="gem update \$(cat \$DOTFILES/default/gems)"
...
alias clippy="cargo clippy -- -W clippy::pedantic -A clippy::missing-errors-doc -A clippy::missing-panics-doc"
