...
set -gx NOTES_HOME "$HOME/vaults/io"
set -gx PROJECT_HOME "$HOME/code"

set -gx EDITOR nvim
set -gx MANPAGER 'nvim +Man!'

set -gx FZF_ALT_C_OPTS "--preview='fzf-preview {}'"
set -gx FZF_CTRL_T_OPTS "--preview='fzf-preview {}'"
...
fish_add_path --global $XDG_DATA_HOME/nvim/mason/bin
